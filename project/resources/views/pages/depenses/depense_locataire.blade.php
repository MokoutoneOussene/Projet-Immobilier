                ...
                <div class="row align-items-center justify-content-between">
                    <div class="col-auto mt-4">
                        ...
                        <div class="page-header-subtitle mt-3">
                            Effectué des depenses au compte des locataires
                        </div>
                    </div>
    ...
    <div class="container-xl px-4 mt-n10">
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="card mb-4">
                    <div class="card-body">
                        <div style="background: linear-gradient(90deg, rgb(164, 216, 231) 0%, rgb(198, 233, 175) 100%); border-radius: 5px;">
                            <form action="{{ route('filter_dep_locat') }}" method="GET">
