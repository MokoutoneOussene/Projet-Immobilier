                                ...
                                <div class="card mb-4">
                                    <div class="card-body">
                                        <div class="sbp-preview-content">
                                            <form method="POST"
                                                action="{{ route('Gestion_locataires.update', [$finds->id]) }}">
                                                @csrf
                                                @method('PATCH')
                                                <div class="p-2 m-1"
                                                    ...
                                                    <div class="col-lg-6 col-md-12">
                                                        <div class="mb-3">
                                                            ...
                                                            <input class="form-control" name="caution_electricite"
                                                                type="number" value="{{ $finds->caution_electricite }}" />
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-6 col-md-12">
                                                        <div class="mb-3">
                                                ...
                                                <div class="row p-2 m-1 d-flex justify-content-between"
                                                    ...
                                                    <div class="col-lg-8 col-md-12"
                                                        style="border: 2px solid rgb(242, 199, 174); border-radius: 5px;">
                                                        <h6 class="m-2 text-center text-danger">Personne à prévenir en cas
                                                            de besoin</h6>
                                                        <div class="mb-3">
                                                            <label>Nom complet</label>
                                                            <input class="form-control" name="prevent_name"
                                                                type="text" value="{{ $finds->prevent_name }}" />
                                                        </div>
                                                        <div class="mb-3">
                                                            <label>N° Téléphone</label>
                                                            <input class="form-control" name="prevent_phone"
                                                                type="number" value="{{ $finds->prevent_phone }}" />
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="mt-3">
