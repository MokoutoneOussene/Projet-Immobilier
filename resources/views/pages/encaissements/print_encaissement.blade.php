    ...
    <div class="container-fluid mt-1">
        <div style="border-bottom: 1px solid black;">
            <div class="d-flex col-md-12">
                <div class="col-12">
                    ...
                    <h5 class="text-center">Située à Ouagadougou secteur 28 (Coté Est de la pédiatrie Charles de Gaule)</h5>
                </div>
            </div>
            <div class="">
        ...
        <section class="mt-4 mb-4">
            <div class="d-flex justify-content-between">
                ...
                <div>
                    <h5>par {{ $finds->User->nom }} {{ $finds->User->prenom }}</h5>
                </div>
            </div>
        ...
        <section>
            <table class="table table-bordered">
                ...
                <tr>
                    <td height="100">{{ $finds->Location->code }}</td>
                    <td>
