                ...
                <div class="row align-items-center justify-content-between">
                    <div class="col-auto mt-4">
                        ...
                        <div class="page-header-subtitle mt-3">
                            <a class="btn btn-primary" href="{{ route('Gestion_location.index') }}" class="btn btn-success">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-12 col-md-12">
                                                            ...
                                                            <input type="text" name="situation" class="form-control"
                                                                value="En cours" hidden>
                                                            <div class="mb-3">
                                                                <label>Locataire</label>
                                                                <select name="locataires_id"
                                                ...
                                                <div class="row p-2 m-1"
                                                    ...
                                                    <div class="col-lg-4 col-md-12">
                                                        <div class="mb-3">
                                                            ...
                                                            <input class="form-control" type="text" id="immeubles_id"
                                                                readonly />
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-4 col-md-12">
                                                        <div class="mb-3">
                                                            ...
                                                            <input class="form-control" type="text" id="typeMaison"
                                                                readonly />
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-4 col-md-12">
